"use client";
import { selectFieldsPersonal } from "@/app/components/common/allConstants/formConstants";
import {
  basicInfo,
...
import { initialValuesPersonalProps } from "@/types/formTypes";
import { useFormik } from "formik";
import Image from "next/image";
import React from "react";

const initialValues: initialValuesPersonalProps = {
  hd: "",
  occupation: "",
  employment: "",
  ai: "",
        ...
        <main className="w-full rounded-3xl sm:border-[0.5px] sm:border-gray mt-14 mb-40">
          <div className="px-1 sm:px-12 py-1 sm:py-12">
            ...
            <div className="w-[94%] sm:w-[83%] h-[8px] bg-gray rounded-full mb-4 mx-auto">
              <div className="bg-[#F97E27] h-[8px] rounded-full w-[50%]"></div>
            </div>
            <div className="flex justify-between text-[14px] leading-5 sm:border-b sm:border-b-gray pb-12 font-semibold sm:px-8">
              ...
              <h3 className="text-[#F97E27] ml-14 mm:ml-20 xsm:ml-28">
                Personal Details
              </h3>
              <h3 className="text-[#ABB7C2] ml-20 sm:ml-12">Partner Preferences</h3>
            </div>
          </div>
          ...
          <div className="px-7">
            ...
            >
              {selectFieldsPersonal?.map((fieldData) => (
                <SelectField
